    ...
    <div data-barba="container">
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ subModelOpen: true,subtab:'place' }">
                    <div  class="fixed h-screen bottom-0 bg-white z-[60] w-full pt-3 pb-8 text-xl font-semibold text-center shadow-xl rounded-t-3xl bg-gray-50 ">
