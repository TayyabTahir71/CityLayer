    ...
    <div data-barba="container">
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{modelOpen: false,showMore: false,hidetab:'no',tab: 'place' }">
                    <div
                        ...
                        <a class="w-full pt-4" @click="tab ='place'; modelOpen =true;" >
                    ...
                    <div class="parentDiv" x-data="{ height: 'auto',searchQuery: ''}">
