                                ...
                                <div x-show="subtab=='observation'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
                                    ...
                                    <div class="flex items-center justify-center gap-2 italic font-semibold pt-28" x-show="tab=='observation'">
                                        ...
                                        <div class="" @click="tab='place1'">
                                            <img class="w-16 h-16" src="{{ asset('img/msg.PNG') }}http://127.0.0.1:8000/img/comfortable.png" alt="">
                                        </div>
                                        <div class="" @click="tab='place1'">
                                            <img class="w-16 h-16" src="{{ asset('img/msg.PNG') }}http://127.0.0.1:8000/img/confused.png" alt="">
                                        </div>
                                        <div class="" @click="tab='place1'">
                                            <img class="w-16 h-16" src="{{ asset('img/msg.PNG') }}http://127.0.0.1:8000/img/sad.png" alt="">
                                        </div>
                                        <div class="" @click="tab='place1'">
                                            <img class="w-16 h-16" src="{{ asset('img/msg.PNG') }}http://127.0.0.1:8000/img/happy.png" alt="">
                                        </div>
                                        <div class="" @click="tab='place1'">
                                            <img class="w-16 h-16" src="{{ asset('img/msg.PNG') }}http://127.0.0.1:8000/img/disgusted.png" alt="">
                                        </div>
