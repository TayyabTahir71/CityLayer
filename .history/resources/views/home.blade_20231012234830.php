                                            ...
                                            <div class="flex items-start justify-center gap-10 mt-6 mb-6 italic font-semibold all-places"
                                                ...
                                                @foreach($allPlaces as $key=>$place)
                                                    ...
                                                    class="flex flex-col items-center"
                                                        ...
                                                        <div data-childPlaces="1212" data-placeID="{{ $place->id }}" class="w-[76px] h-[76px] rounded-full bg-[#2d9bf0]"
    ...
    <script>
        ...
        $('body').on('click', '.submitData', function() {
            ...
            if($homeTab=='place'){
                ...
                console.log($(this).closest('.parentDiv').find('.placeActive').data('childPlaces'));
                console.log(placeID);
            }
