        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: false,subtab:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-data="{subactive:'{{ isset($edited_place->placeDetail->place_id) ? "PL_".$edited_place->placeDetail->place_id : "" }}'}" class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
