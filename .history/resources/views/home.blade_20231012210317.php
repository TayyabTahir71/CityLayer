        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div x-data="{ showMore: false, height: 'auto' }">
                        <div x-cloak x-show="modelOpen " class="fixed bottom-0 z-50 overflow-y-auto"
                            ...
                            <div class="flex items-end justify-center text-center">
                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    class="transition-height parentDiv z-50 w-screen p-4 pb-16 transition-all transform bg-white h-[50%] shadow-xl mt-60 rounded-t-3xl"
                                    :style="'height: ' + height"
                                    :class="{'overflow-auto': showMore }"
                                    >

                                    <div class="p-2 lg:p-4" x-data="{ tab: 'place' }">

                                        <div @click="showMore = false; height = 'auto'; modelOpen=false" x-show="showMore" class="mb-4">
                                        ...
                                        <div class="" x-data="{ active: '' }">
                                            ...
                                            <div class="flex items-start justify-center gap-10 mt-6 mb-6 italic font-semibold all-places"
                                                ...
                                                @foreach($allPlaces as $key=>$place)
                                                    <div x-show="showMore || {{ $key }} < 2" class="flex flex-col items-center"
                                            ...
                                            <div class="flex items-center justify-center gap-10 mt-6 italic font-semibold"
                                                ...
                                                <div class="grid grid-cols-3 italic font-semibold gap-10"
                                                    ...
                                                    <div x-show="showMore || {{ $key }} < 2" class="flex flex-col items-center"
                                                        ...
                                                        <div data-observationID="{{ $observation->id }}" class="w-[76px] h-[76px] rounded-full bg-[#ffa726]"
                        ...
                        <div  x-cloak x-show="modelOpen" class="fixed w-full bottom-0 z-50 bg-black py-4">
                            <div class="flex items-center justify-center">
                                <div 
                                    {{-- onclick="submitData()" --}}
