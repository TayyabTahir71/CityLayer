                                ...
                                <div class="px-1 pt-4" x-data="{ tab: 'place' }">
                                    ...
                                    <div class="" x-data="{ active: '' }">
                                        ...
                                        <div class="flex items-start justify-center gap-10 mt-6 italic font-semibold all-places"
                                            ...
                                            <div class="flex items-start justify-center  italic font-semibold gap-10"
                                                id="searchResults2Pls">
                                                <div class="flex flex-col items-center justify-center cursor-pointer"
                                                    @click="active='PL_{{ $allPlaces[0]->id }}'"
                                                    onclick="select_place({{ $allPlaces[0]->id }})">
                                                    <div class="rounded-full bg-[#2d9bf0] p-[24px] "
                                                ...
                                                <div class="flex flex-col items-center justify-center cursor-pointer"
                                                    ...
                                                    <span class="mt-4 text-black font-normal">{{ $allPlaces[1]->name }}</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex items-center justify-center gap-10 mt-6 italic font-semibold"
                                            ...
                                            <div class="flex items-center justify-center  italic font-semibold gap-10"
                                                ...
                                                <div class="flex flex-col items-center justify-center cursor-pointer"
                                                    ...
                                                    <div class="rounded-full bg-[#ffa726]  px-[10px] py-[22px]"
                                    ...
                                    <div class="flex items-center justify-center mt-8">
                                        <div onclick="submitData()"
                                            class="flex cursor-pointer items-center justify-center gap-2 px-4 py-3 text-lg font-extrabold text-white bg-[#2d9bf0] rounded-3xl hover:shadow  hover:bg-[#268ede] transition-all">
                    ...
                    <div id="myfeel2" class="bg-white" x-data="{ seeMore: false }">
                        ...
                        <div x-cloak x-show="seeMore" class="absolute inset-0 z-[60] bg-white"
                            ...
                            <div x-cloak x-show="seeMore" x-transition:enter="transition ease-out duration-300 transform"
                                ...
                                x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100"
                                x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                class="z-50 transition-all transform bg-white">
                                ...
                                <div class="p-6 lg:p-12" x-data="{ tab: 'place' }">
                                    ...
                                    <div class="flex items-center justify-center mt-12">
                                        <div class=" cursor-pointer" @click="tab='place'">
                                            <div class="flex flex-col w-[84px] justify-center items-center">
                                                <div class="bg-[#2d9bf0] border-2 border-white rounded-full shadow-xl"
                                                    :class="tab == 'place' || tab == 'place1' ?
                                                        'bg-[#2d9bf0] z-10 p-[26px]' :
                                    ...
                                    <div x-data="{ active: '' }">
                                        <div class="flex flex-col items-center justify-center gap-10 mt-6 italic font-semibold"
                                            x-show="tab=='place'">
                                            <div class="grid grid-cols-3 lg:grid-cols-3 gap-x-0 gap-y-8 items-start" id="searchResultsPls">
                                    ...
                                    <div x-data="{ active: '' }">
                                        <div class="flex flex-col items-center justify-center gap-10 mt-6 italic font-semibold"
                                            x-show="tab=='observation'">
                                            <div class="grid grid-cols-3 lg:grid-cols-3 gap-8 items-start" id="searchResultsObs">
                                                @foreach ($allObservations as $obs)
                                                    <div class="flex flex-col items-center text-center justify-center w-[80px]"
