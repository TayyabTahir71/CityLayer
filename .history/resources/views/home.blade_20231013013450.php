...
@section('main')
    <div x-data="{ subModelOpen: false, subtab:'place', subactive=''}" data-barba="container">
            ...
            if($homeTab=='place' && placeID){
                ...
                if(childplaces.length>0){
                    ...
                    childplaces.forEach(place => {
                        allHtml+=`
                        <div class="flex flex-col items-center" @click="subactive='SPL_${place.id}'">
                                            <div data-subplaceid="${place.id}" class="w-[76px] h-[76px] rounded-full bg-[#2d9bf0]" 
                                            :class="subactive == 'PL_${place.id}' ? 'border-4 border-blue-300 subplaceActive' : ''">
                                                <div class="flex align-item-center justify-center items-center h-full">
                                                    <img src="{{ asset('new_img/image.png') }}" class="w-7 h-7" />
                                                </div>
                                            </div>
