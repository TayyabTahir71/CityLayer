        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div class="parentDiv" x-data="{ showMore: false, height: 'auto',searchQuery: '',tab: 'place' }">
                        <button class="hidden OpenObservationModel" @click="modelOpen=true; showMore = true; tab='observation'; height = '100vh';"></button>
                ...
                <div class="parentDiv" x-data="{ subModelOpen: false,subtab:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-data="{subactive:''}" class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div @click="subModelOpen=false;subactive='';subtab=''" class="mb-4 OpenObservationModel">
                                <img src="{{ asset('img/icons/arrow.png') }}" class="arrow">
                            </div>
