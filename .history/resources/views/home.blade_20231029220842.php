        ...
        $('body').on('click', '.submitData', function() {
            ...
            if($homeTab=='place' && place_detail.id){
                ...
                if(edited_place.observations_detail.length>0){     
                    console.log(edited_place.observations_detail);
                    
                    edited_place.observations_detail.forEach(function(observation) {
                        if (observation.child && observation.child.length > 0) {
                            observation.child.forEach(observ => {
                                console.log('if feel_'+observation.observation_id+'_'+observ.id+'_'+observation.feeling_id);
                            });
                                
                        }else{
                            console.log('else feel_'+observation.observation_id+'_'+observation.feeling_id);
                        }
                    });
