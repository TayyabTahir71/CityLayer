                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    <div class="p-6 lg:p-12">
                                        ...
                                        <div class="flex items-center justify-center mt-12 homeTabs">
                                            <div class="-mr-1 cursor-pointer" x-show="if(HideTab != 'place')" @click="tab='place'">
                                            ...
                                            <div class="-ml-1 cursor-pointer" x-show="@if(HideTab != 'observation')" @click="tab='observation'">
