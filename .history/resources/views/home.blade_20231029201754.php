                                        ...
                                        <div class="" x-data="{ active: '' }">
                                            <div class="flex items-center justify-center gap-10 mt-6 mb-6 italic font-semibold"
                                                ...
                                                <div class="grid grid-cols-3 italic font-semibold gap-10"
                                                    ...
                                                    <?php 
                                                    if ($edited_place->observationsDetail->contains('observation_id', $observationIdToCheck)) {
                                                        // The observation with the specified ID exists in $edited_place->observationsDetail.
                                                        // You can add your code here to handle the case when the observation exists.
                                                    } else {
                                                        // The observation with the specified ID does not exist in $edited_place->observationsDetail.
                                                        // You can add your code here to handle the case when the observation does not exist.
                                                    }
                                                    ...
                                                    ?>
                                                        ...
                                                        >
                                                        {{-- <div x-data="{ active: '{{ isset($edited_place->observationDetail->place_id) ? "PL_".$edited_place->placeDetail->place_id : "" }}' }"> --}}
