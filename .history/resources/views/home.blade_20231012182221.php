    ...
    <div data-barba="container">
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ showMore: false, height: 'auto', modelOpen: false }">
                    <div
                    ...
                    <input type="text" class="fixed top-0 z-50 w-full px-2 py-2 bg-white rounded-full"
                    placeholder="Choose tags or add new city layers" name="searchInput"
                    id="searchInput">

                    <div  x-cloak x-show="modelOpen " class="relative bottom-0 z-50 overflow-y-auto"
                                    ...
                                    <div class="" x-data="{ active: '' }">
                                        ...
                                        <div class="flex items-start justify-center gap-10 mt-6 italic font-semibold all-places"
                                            ...
                                            @foreach($allPlaces as $key=>$place)
                                                <div x-show="showMore || {{ $key }} < 2" class="w-[76px] cursor-pointer"
                                                    @click="active='PL_{{ $place->id }}'">
                                                    <div data-placeID="{{ $place->id }}" class="rounded-full bg-[#2d9bf0] p-[24px]"
                    ...
                    <div class="fixed bottom-0 z-50 flex items-center justify-center mt-8">
                        <div 
                            {{-- onclick="submitData()" --}}
