                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div  x-data="{ showMore: false, height: 'auto' }" x-cloak x-show="modelOpen " class="fixed bottom-0 z-50 overflow-y-auto"
                        ...
                        <div class="flex items-end justify-center text-center">
                            ...
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolore delectus adipisci, reiciendis qui accusantium ipsa sapiente assumenda a? Alias et asperiores eum quae exercitationem amet deserunt aliquid voluptate adipisci ipsa?
                        </div>
                    </div>
