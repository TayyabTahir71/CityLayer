    ...
    <div data-barba="container">
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: true, tab:'subplace', subactive:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div class="flex items-center justify-center mt-12 homeTabs">
                                <div class="-mr-1 cursor-pointer" @click="tab='subplace'">
                                    <div class="flex flex-col w-[84px] justify-center items-center">
                                        <div class="bg-[#2d9bf0] border-2 border-white rounded-full"
                                            :class="tab == 'subplace'?
                                                ...
                                                'bg-[#2d9bf0]/70 p-[40px]'">
                                            <img src="{{ asset('new_img/image.png') }}" class="w-7 h-7"
                                                :class="tab == 'subplace' ? 'block' : 'hidden'"
                                                alt="">
                                        </div>
                                       
                                    </div>
                                </div>
                                <div class="-ml-1 cursor-pointer" @click="tab='subobservation'">
                                    <div class="flex flex-col w-[75px] justify-center items-center">

                                        <div class="flex items-center justify-center border-2 border-white rounded-full"
                                            :class="tab == 'subobservation' ?
                                                'bg-[#ffa726] z-10 p-[20px] subobservationTabActive' :
                                                'bg-[#ffa726]/70 p-[40px]'">
                                            <div class="flex items-center justify-center w-10 h-10 text-2xl"
                                                :class="tab == 'subobservation' ? 'block' :
                                                    'hidden'"
                                                >
                                                <div class="flex align-item-center justify-center items-center h-full">
                                                    <img src="{{ asset('new_img/sad.png') }}" alt=""
                            ...
                            <div>
                                ...
                                <div x-show="tab=='subplace'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
                                ...
                                <div  x-show="tab=='subobservation'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
