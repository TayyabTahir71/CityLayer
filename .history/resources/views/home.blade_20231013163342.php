            ...
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div class="parentDiv" x-data="{ showMore: false, height: 'auto',searchQuery: '',tab: 'place' }">
                        ...
                        <button class="hidden openPlaceModel" @click="modelOpen=true; showMore = true; tab='place'; height = '100vh';"></button>
                ...
                <div class="parentDiv" x-data="{ subModelOpen: false,subtab:'',hidesubtab=''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-data="{subactive:''}" class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div class="flex items-center justify-center mt-12 homeTabs">
                                <div class="-mr-1 cursor-pointer" x-show="subtab=='place'"  x-show="hidesubtab=='' || hidesubtab=='place'">
                                    <div class="flex flex-col w-[84px] justify-center items-center">
