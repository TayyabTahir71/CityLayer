                ...
                `<div class="bg-[#2d9bf0] p-0 w-full">
                    ...
                    <div x-data="activeliked(${place.id},${like})" class="absolute bottom-[-12px] w-full left-0 px-[10px]">
                        ...
                        <div class="absolute left-0 w-full" x-show="comment${place.id}">
                            <textarea type="text" data-id="${place.id}" class="w-full rounded-xl h-[60px] focus:outline-none focus:border-0 focus:ring-0 bg-[#2d9bf0] border-0 italic text-white placeholder-white leading-2 text-sm w-10/12" placeholder="Put your feedback"></textarea>
                            <button class="border-2 border-site px-2 py-1 text-white bg-[#2d9bf0] rounded-3xl cursor-pointer float-right">Save</button>
                        </div>
                    </div>
