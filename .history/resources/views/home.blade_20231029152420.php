...
@section('main')
    ...
    <script>
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            const isliked={{backpack_auth()->user()->likedPlaces->contains('place_detail_id', $place->id)}}
            ...
            markerx = L.marker([placelatitude, placelongitude], {
                ...
                `<div class="bg-[#2d9bf0] p-0 w-full">
                    ...
                    <div x-data="{like${place.id}:false}" class="absolute bottom-[-12px] w-full left-0 px-[10px]">
                        <div class="flex italic font-light text-white justify-between items-center">
                            <div class="likecomment flex gap-10 items-center">
                                <div class="cursor-pointer"><img src="{{ asset('img/msg.PNG') }}" class="h-9 mt-[8px]"></div>  
                                  
                                <div onclick="setlike(${place.id})" @click="like${place.id}=!like${place.id}" class="cursor-pointer bg-[#0078d9] text-center text px-2 rounded">
                                    <i class="fa fa-heart" 
                                    :class="like${place.id} ? 'fa-heart text-[#ffc543]' : 'fa-heart-o'"
                                    ></i></div>    
                            </div>
