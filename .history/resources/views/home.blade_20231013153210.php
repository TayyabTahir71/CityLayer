...
@section('main')
    <div data-barba="container" x-cloak x-data="{modelOpen: false, subModelOpen: false,subtab:'',showMore: false, height: 'auto',searchQuery: '',tab: 'place',active: '',subactive:'',show: false}">
