...
@section('main')
            ...
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                            ...
                            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                                ...
                                <div class="px-1 pt-4" x-data="{ tab: 'place' }">
                                    ...
                                    <div class="flex items-center justify-center mt-8">
                                        <div 
                                            {{-- onclick="submitData()" --}}
                                            class="submitData flex cursor-pointer items-center justify-center gap-2 px-4 py-3 text-lg font-extrabold text-white bg-[#2d9bf0] rounded-3xl hover:shadow  hover:bg-[#268ede] transition-all">
                    ...
                    <div id="myfeel2" class="bg-white" x-data="{ seeMore: false }">
                        <button id="othertag" @click="seeMore =!seeMore" class="z-100">tayyab</button>
    ...
    <script>
        ...
        $('body').on('click', '.submitData', function() {
            var parentDiv = $(this).closest('.parentDiv').find('.placeActive').data('placeid');
            alert(parentDiv);
        });
