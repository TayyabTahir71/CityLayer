        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: false,subtab:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-data="{subactive:'',feelActive:'feel_1'}" class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                                    ...
                                    <div class="flex items-center justify-center gap-2 italic font-semibold pt-12">
                                        ...
                                        @foreach($feelings as $feeling)
                                            <div
                                                ...
                                                >
                                                <img class="w-16 h-16" data-id="{{$feeling->id}}" src="{{ asset($feeling->image) }}" alt="">
                                            </div>
                                        @endforeach
