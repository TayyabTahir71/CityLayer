        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div class="parentDiv" x-data="{ showMore: false, height: 'auto',searchQuery: '',tab: 'place',HideTabPl: 'no' }">
                            ...
                            <div class="flex items-end justify-center text-center">
                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    <div class="p-6 lg:p-12">
                                        ...
                                        <div class="closeAddProcess mb-4" @click="modelOpen=false; showMore = false; height = 'auto';HideTab='no'" x-show="showMore" class="mb-4">
