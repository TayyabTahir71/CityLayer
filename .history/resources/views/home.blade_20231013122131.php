    ...
    <div data-barba="container">
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: true}" x-cloak x-show="subModelOpen">
                    <button class="hidden subModeltriger" @click="subModelOpen=true,subtab='observation'"></button>
                    <div class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        
                        <div x-data="{subactive:'', subtab:''}" class="p-6 lg:p-12">
