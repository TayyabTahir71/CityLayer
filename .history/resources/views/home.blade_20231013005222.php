...
@section('main')
    <div x-data="{ subModelOpen: true, subtab:'place' }" data-barba="container">
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-cloak x-show="subModelOpen">
                    <button class="hidden" @click="subModelOpen=true">asdfasdfa</button>
                    <div  class="fixed h-screen bottom-0 bg-white z-[60] w-full pt-3 pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                                    ...
                                    <div class="flex flex-col w-[75px] justify-center items-center">
                                        ...
                                        <div class="flex items-center justify-center border-2 border-white rounded-full"
                                            :class="subtab == 'observation' ?
                                                'bg-[#ffa726] z-10 p-[20px] observationTabActive' :
                                                'bg-[#ffa726]/70 p-[40px]'">
                                            <div class="flex items-center justify-center w-10 h-10 text-2xl block">
                                                <div class="flex align-item-center justify-center items-center h-full">
                                                    <img src="{{ asset('new_img/sad.png') }}" alt=""
                                                        class="w-8 h-8 -mr-1"> <img
                                                        src="{{ asset('new_img/happy.png') }}" alt=""
                            ...
                            <div>
                                ...
                                <div  x-show="subtab=='place'" class="flex items-start justify-center gap-10 mt-6 mb-6 italic font-semibold all-subplaces">
