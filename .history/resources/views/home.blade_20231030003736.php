        ...
        for (let i = 0; i < data.length; i++) {
            ...
            markerx = L.marker([placelatitude, placelongitude], {
                ...
                `<div class="bg-[#2d9bf0] p-0 w-full">
                    ...
                    <div x-data="activeliked(${place.id},${like})" class="absolute bottom-[-12px] w-full left-0 px-[10px]">
                        <div class="flex italic font-light text-white justify-between items-center">
                            <div class="likecomment flex gap-10 items-center">
                                <div @click="comment${place.id}=!comment${place.id}" class="cursor-pointer"><img src="{{ asset('img/msg.PNG') }}" class="h-9 w-20 mt-[8px]"></div>  
                            ...
                            <div class="">Added by ` + username + ` on ` + formattedDate + `</div>
                        </div>
