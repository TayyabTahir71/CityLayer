        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: true, subtab:'place', subactive:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div>
                                ...
                                <div  x-show="subtab=='place'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold all-subplaces">
                                    ...
                                    <div class="flex items-center justify-between w-2/3 pt-28">
