        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ subModelOpen: false, subtab:'place', subactive:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-cloak x-show="subModelOpen" class="fixed w-full bottom-0 z-50 bg-white py-4">
                        <div class="flex items-center justify-center">
                            <div 
                                {{-- onclick="submitData()" --}}
                                class="submitDataAll flex cursor-pointer items-center justify-center gap-2 px-8 py-3 text-lg font-extrabold text-white bg-[#2d9bf0] rounded-3xl hover:shadow  hover:bg-[#268ede] transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="3" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
