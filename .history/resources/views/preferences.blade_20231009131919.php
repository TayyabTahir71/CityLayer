...
foreach ($preferences as $preference) {
    $isChecked = in_array($preference, $preference) ? "checked" : "";
    echo '
    <label>
        <input type="checkbox" name="preferences[]" value="' . htmlspecialchars($preference) . '" ' . $isChecked . ' class="sr-only peer">
        <div class="group mb-3 flex items-center bg-yel rounded border p-3 ring-offset-2 peer-checked:text-white peer-checked:bg-[#CDB8EB] bg-purple-200 peer-focus:ring-2">
            <div class="flex justify-center text-white">
                <div class="font-semibold">' . __($preference) . '</div>
            </div>
        </div>
    </label>
    ';
