...
<script>
        ...
        $('body').on('click', '.submitDataAll', function() {
            ...
            if (parentDiv.hasClass('placeTab')) {
                ...
                }else if(parentDiv.find('.'+tab+'SubTab').hasClass('choose') && parentDiv.find('.PlaceItems').hasClass('parent')){

                    var place_detail = parentDiv.find('.placeActive').data('place');

                    console.log(place_detail.id);
                    if (place_detail && typeof place_detail.id === 'undefined') {
                        return false;
                    }
                ...
                }else if(parentDiv.find('.'+tab+'SubTab').hasClass('choose') && parentDiv.find('.PlaceItems').hasClass('child')){
