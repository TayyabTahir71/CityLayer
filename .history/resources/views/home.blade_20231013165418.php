        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div class="parentDiv" x-data="{ showMore: false, height: 'auto',searchQuery: '',tab: 'place',ShowTabPl: true }">
                        <button class="hidden OpenObservationModel" @click="modelOpen=true; showMore = true; ShowTabPl=false; tab='observation'; height = '100vh';"></button>
                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    <div class="p-6 lg:p-12">
                                        ...
                                        <div class="flex items-center justify-center mt-12 homeTabs">
                                            <div class="-mr-1 cursor-pointer" x-show="HideTabPl" @click="tab='place'">
                                            ...
                                            <div class="-ml-1 cursor-pointer" x-show="HideTab='place'" @click="tab='observation'">
