...
@section('main')
    <div data-barba="container" x-data="{modelOpen: false, subModelOpen: false,subtab:'',showMore: false, height: 'auto',searchQuery: '',tab: 'place',active: '',subactive:'',show: false}">
        <div x-cloak class="flex flex-col mx-auto">
            <div class="">
                <div class="relative">
                    <div class="">
                ...
                <div>
                    ...
                    <div class="parentDiv">
                        <button class="hidden OpenObservationModel" @click="modelOpen=true; showMore = true; height = '100vh'; tab='observation'"></button>
                    
                        <div x-cloak x-show="modelOpen " class="fixed bottom-0 z-50 overflow-y-auto"
                            aria-labelledby="modal-title" role="dialog" aria-modal="true">
                            <div class="flex items-end justify-center text-center">
                                <div class="closeAddProcess" x-cloak @click="modelOpen = false" x-show="modelOpen"
                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    <div class="p-6 lg:p-12">
                                        ...
                                        <div class="closeAddProcess mb-4" @click="modelOpen=false; showMore = false; height = 'auto';" x-show="showMore" class="mb-4">
                ...
                <div class="parentDiv" x-cloak x-show="subModelOpen">
                    {{-- <button class="hidden openPlaceModel" @click="subModelOpen=true;subtab='place'"></button> --}}
                    ...
                    <div class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div @click="subModelOpen=false;subactive='';subtab=''" class="mb-4">
                                <img src="{{ asset('img/icons/arrow.png') }}" class="arrow">
                            </div>
