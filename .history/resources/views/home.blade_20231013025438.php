        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: true, subactive:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-data="{ subtab: '1' }"  class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div class="flex items-center justify-center mt-12 homeTabs">
                                <div class="-mr-1 cursor-pointer" @click="subtab='1'">
                                    <div class="flex flex-col w-[84px] justify-center items-center">
                                        <div class="bg-[#2d9bf0] border-2 border-white rounded-full"
                                            :class="subtab == '1'?
                                                ...
                                                'bg-[#2d9bf0]/70 p-[40px]'">
                                            <img src="{{ asset('new_img/image.png') }}" class="w-7 h-7"
                                                :class="subtab == '1' ? 'block' : 'hidden'"
                                                alt="">
                                        </div>
                                       
                                    </div>
                                </div>
                                <div class="-ml-1 cursor-pointer" @click="subtab='2'">
                                    <div class="flex flex-col w-[75px] justify-center items-center">
                            ...
                            <div>
                                ...
                                <div x-show="subtab==1" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
                                ...
                                <div x-show="subtab=='2'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
