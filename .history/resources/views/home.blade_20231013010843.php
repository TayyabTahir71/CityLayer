...
@section('main')
    <div x-data="{ subModelOpen: false, subtab:'place' }" data-barba="container">
        <button class="hidden subModeltriger" @click="subModelOpen=true"></button>
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div class="parentDiv" x-data="{ showMore: false, height: 'auto',searchQuery: '' }">
                            ...
                            <div class="flex items-end justify-center text-center">
                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    <div class="p-6 lg:p-12" x-data="{ tab: 'place' }">
                                        ...
                                        <div @click="modelOpen=false; showMore = false; height = 'auto';" x-show="showMore" class="mb-4">
                                            ...
                                            <div class="flex items-start justify-center gap-10 mt-6 mb-6 italic font-semibold all-places"
                                                ...
                                                @foreach($allPlaces as $key=>$place)
                                                    ...
                                                    class="flex flex-col items-center"
                                                        ...
                                                        <div data-childplaces="{{json_encode($place->subplaces)}}" data-placeID="{{ $place->id }}" class="w-[76px] h-[76px] rounded-full bg-[#2d9bf0]"
                                            ...
                                            <div class="flex items-center justify-center gap-10 mt-6 mb-6 italic font-semibold"
                                                ...
                                                <div class="grid grid-cols-3 italic font-semibold gap-10"
                                                    ...
                                                    <div 
                                                        ...
                                                        <div data-childobservations="{{json_encode($place->subobservs)}}" data-observationID="{{ $observation->id }}" class="w-[76px] h-[76px] rounded-full bg-[#ffa726]"
                ...
                <div x-cloak x-show="subModelOpen">
                    
                    <div  class="fixed h-screen bottom-0 bg-white z-[60] w-full pt-3 pb-8 text-xl font-semibold text-center shadow-xl">
                        
                        <div class="p-6 lg:p-12">

                            <div @click="subModelOpen=false;" class="mb-4">
                                <img src="{{ asset('img/icons/arrow.png') }}" class="arrow">
                            </div>


                            <div class="flex items-center justify-center mt-12 homeTabs">
                                <div class="-mr-1 cursor-pointer" @click="subtab='place'">
                                    <div class="flex flex-col w-[84px] justify-center items-center">
                                ...
                                <div class="-ml-1 cursor-pointer" @click="subtab='observation'">
                                    <div class="flex flex-col w-[75px] justify-center items-center">
                            ...
                            <div>
                                <div class="placeparent mt-16">Park</div>
                                <div  x-show="subtab=='place'" class="flex items-start justify-center gap-10 mt-4 mb-6 italic font-semibold all-subplaces">
                                ...
                                <div  x-show="subtab=='observation'" class="flex items-start justify-center gap-10 mt-6 mb-6 italic font-semibold all-subplaces">
                                    <div class="grid grid-cols-3 italic font-semibold gap-10">
                                            sub observation
                                    </div>
                                </div>
    ...
    <script>
        ...
        $('body').on('click', '.submitData', function() {
            ...
            var childplaces = $(this).closest('.parentDiv').find('.placeActive').data('childplaces');
            var observationID = $(this).closest('.parentDiv').find('.observationActive').data('observationid');
            var childobservations = $(this).closest('.parentDiv').find('.observationActive').data('childobservations');

            var $homeTab = $(this).closest('.parentDiv').find('.observationTabActive').length > 0 ? 'observation' : 'place';

            if($homeTab=='place' && placeID){

                place_data['place_id']=placeID;
                ...
                if(childplaces.length>0){
                    ...
                    // subPlacesItems
                    var allHtml = '';
                    childplaces.forEach(place => {
                        allHtml+=`
                        <div class="flex flex-col items-center" @click="active='PL_2'">
                                            <div data-childplaces="[]" data-placeid="2" class="w-[76px] h-[76px] rounded-full bg-[#2d9bf0]" 
                                            :class="active == 'PL_2' ? 'border-4 border-blue-300 placeActive' : ''">
                                                <div class="flex align-item-center justify-center items-center h-full">
                                                    <img src="{{ asset('new_img/image.png') }}" class="w-7 h-7" />
                                                </div>
                                            </div>
                                            <span class="mt-4 text-black font-normal">Public square</span>
                                        </div>
                        `;
                        console.log(place);
                        // childPlacesContainer.appendChild(placeElement);
                    });
                    $('.subPlacesItems').html(allHtml);

                    $('.subModeltriger').click();
                    
                }

                
            }else if($homeTab=='observation' && observationID){
                console.log(childobservations);
            }

            console.log(place_data);
            // alert(placeID+" "+observationID+" "+$homeTab);
