                                ...
                                <div x-show="subtab=='observation'" class="flex flex-col items-center justify-center">
                                    ...
                                    <div class="flex items-center justify-between w-2/3 pt-20 pb-16 mb-12">
                                        ...
                                        <div class="relative" x-data="{ observationText: false }">
                                            ...
                                            <textarea class="font-normal observation_description absolute px-2 py-2 bg-white rounded-xl w-[300px] right-0" x-show="observationText">{{$edited_place->obsevation_description?$edited_place->obsevation_description:''}}</textarea>
                                        </div>
