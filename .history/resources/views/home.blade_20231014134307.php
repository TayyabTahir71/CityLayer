            ...
            <div class="">
                ...
                <div x-data="{modelOpen: false,showMore: false,hidetab:'no',tab: 'place',searchQuery: '' }">
                    <div
                        ...
                        <a class="w-full pt-4" @click="tab ='place'; modelOpen =true; searchQuery=''" >
                            ...
                            <div class="flex items-end justify-center text-center">
                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    <div class="p-6 lg:p-12">
                                        ...
                                        <div class="flex justity-between items-center gap-2">
                                            ...
                                            <a href="/add-new-place"class="bg-[#2d9bf0] p-2 transition-all rounded-full hover:bg-blue-400">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: false,subtab:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-data="{subactive:'',feelActive:''}" class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div>
                                ...
                                <div x-show="subtab=='observation'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
                                    ...
                                    <div class="flex items-center justify-center gap-2 italic font-semibold pt-12">

                                        @foreach($feelings as $feeling)
                                            <div data-id="{{$feeling->id}}"
                                                @click="feelActive='feel_{{$feeling->id}}'"
                                                class="cursor-pointer rounded-full"
                                                :class="feelActive == 'feel_{{ $feeling->id }}' ? 'border-4 border-blue-300 feelingActive' : ''"
                                                >
                                                <img class="w-16 h-16" src="{{ asset($feeling->image) }}" alt="">
                                            </div>
                                        @endforeach
    ...
    <script>
        ...
        $('body').on('click', '.submitDataAll', function() {
            ...
            if($SubTab=='place'){
                ...
                var feeling_id = $(this).closest('.parentDiv').find('.feelingActive').data('id');
                if(subobservation_id){
                    place_data['child_observation_id']=subobservation_id;
                }
                if(feeling_id){
                    place_data['feeling_id']=feeling_id;
                }
