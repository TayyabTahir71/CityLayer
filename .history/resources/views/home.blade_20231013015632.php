                ...
                <div x-data="{ subModelOpen: false, subtab:'place', subactive:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-cloak x-show="subModelOpen" class="fixed w-full bottom-0 z-[60] bg-white py-4">
                        <div class="flex items-center justify-center gap-6">
                            <div class="flex cursor-pointer items-center justify-center border-2 border-site gap-2 px-8 py-3 text-lg font-extrabold color-site bg-white rounded-3xl transition-all">
                                Close
                            </div>

                            <div class="submitDataAll flex cursor-pointer items-center justify-center gap-2 px-8 py-3 text-lg font-extrabold text-white bg-[#2d9bf0] rounded-3xl  hover:bg-[#268ede] transition-all">
                                Submit
                            </div>
