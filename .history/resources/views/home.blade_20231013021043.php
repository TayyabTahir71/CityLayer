    ...
    <div data-barba="container">
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: true, subtab:'place', subactive:''}" x-cloak x-show="subModelOpen">
                                ...
                                <div  x-show="subtab=='place'" class="flex items-start justify-center gap-10 mt-4 mb-6 italic font-semibold all-subplaces">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <label for="image-upload">
                                            <img src="http://localhost:8000/img/cam-2.PNG" alt="" class="w-10 h-9">
                                        </label>
                    
                                        <img src="http://localhost:8000/img/msg.PNG" @click="openDes=true" alt="" class="w-10 h-9">
                                    </div>
                                </div>
