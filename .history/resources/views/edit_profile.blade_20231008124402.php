...
<br/>
            <button class="font-bold color-site border border-site p-1 md:p-4 rounded-lg pd editcity" type="submit">Edit city tags</button>
            <br/>
            <button class="font-bold bg-site text-white border border-site p-1 md:p-4 rounded-lg pd">
                Save and close
            </button>   </form>
