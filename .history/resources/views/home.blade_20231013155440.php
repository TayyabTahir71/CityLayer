            ...
            if($homeTab=='place' && place_detail.id){
                ...
                if(observations_detail.child.length>0){
                    ...
                    observations_detail.child.forEach(observ => {
                        allHtml+=`
                        <div class="flex flex-col items-center cursor-pointer" @click="subactive='SPL_${observ.id}'">
                                            <div data-subplaceid="${observ.id}" class="w-[76px] h-[76px] rounded-full bg-[#2d9bf0]" 
                                            :class="subactive == 'SPL_${observ.id}' ? 'border-4 border-blue-300 subplaceActive' : ''">
                                                <div class="flex align-item-center justify-center items-center h-full">
                                                    <img src="{{ asset('new_img/image.png') }}" class="w-7 h-7" />
                                                </div>
                                            </div>
