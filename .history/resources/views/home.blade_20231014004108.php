                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div>
                                ...
                                <div x-show="subtab=='observation'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
                                    ...
                                    <div class="flex items-center justify-center gap-2 italic font-semibold pt-12" x-data="feelActive='feel_1'">

                                        @foreach($feelings as $feeling)
                                            <div
                                                @click="feelActive='feel_1'"
                                                class="cursor-pointer"
                                                :class="feelActive == 'feel_{{ $feeling->id }}' ? 'border-4 border-blue-300 rounded-full feelingActive' : ''"
                                                >
