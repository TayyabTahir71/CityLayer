        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div  x-data="{ showMore: false, height: '70' }" x-cloak x-show="modelOpen " class="fixed bottom-0 z-50 overflow-y-auto"
                        ...
                        <div class="flex items-end justify-center text-center">
                            ...
                            <div x-cloak x-show="modelOpen" 
                                ...
                                :class="{ 'h-screen': showMore, 'overflow-auto': showMore }"
                                >
                                    ...
                                    <div class="" x-data="{ active: '' }">
                                        ...
                                        <div class="flex items-start justify-center gap-10 mt-6 italic font-semibold all-places"
                                            ...
                                            <div x-show="!showMore" class="cursor-pointer">
                                                <button @click="showMore = true; height = '100'">
