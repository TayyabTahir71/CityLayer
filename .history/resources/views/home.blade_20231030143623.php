...
@section('main')
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                            ...
                            <div class="flex items-end justify-center text-center">
                                ...
                                <div x-cloak x-show="modelOpen"
                                    ...
                                    <div class="p-6 lg:p-12">
                                        ...
                                        @if($edit_id)
                                        <a href="/" class="block closeAddProcess mb-4" class="mb-4">
                                            <img src="{{ asset('img/icons/arrow.png') }}" class="arrow">
                                        </a>
                                        @else
                                        <div class="closeAddProcess mb-4" @click="modelOpen=false; showMore = false; hidetab = 'no'; height = 'auto';" x-show="showMore" class="mb-4">
                                            <img src="{{ asset('img/icons/arrow.png') }}" class="arrow">
                                        </div>
                                        @endif
                                        ...
                                        <div class="flex justity-between items-center gap-4">
                                            ...
                                            :href="tab === 'place' ? '/add-new/place{{ $edit_id ? '/' . urlencode($edit_id) : '' }}' : '/add-new/observation{{ $edit_id ? '/' . urlencode($edit_id) : '' }}'"
                                            class="tabNewLink p-2 border-2  transition-all rounded-full"
                                            ...
                                            <div class="flex items-center justify-center gap-10 mt-6 mb-6 italic font-semibold"
                                                ...
                                                <div class="grid grid-cols-3 italic font-semibold gap-10"
                                                    ...
                                                    @foreach($allObservations as $key => $observation)
                                                        ...
                                                        <div
                                                            x-data="{ active: '{{ $edited_place && $edited_place->observationsDetail->contains('observation_id', $observation->id) ? 'OB_'.$observation->id : '' }}' }"
                ...
                <div class="parentDiv" x-data="{ subModelOpen: false,subtab:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-data="{subactive: '{{ isset($edited_place->placeDetail->place_child_id) ? "SPL_".$edited_place->placeDetail->place_child_id : "" }}'}" class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                                ...
                                <div x-show="subtab=='place'"  class="flex flex-col items-center justify-center mt-12">
                                    ...
                                    <div class="flex items-center justify-between w-2/3 pt-28 pb-16 pb-12">
                                        ...
                                        <div class="relative" x-data="{ placeText: false }">
                                            ...
                                            <textarea class="font-normal place_description absolute px-2 py-2 bg-white rounded-xl w-[300px] right-0" x-show="placeText">{{ $edited_place && $edited_place->place_description ? $edited_place->place_description : '' }}</textarea>
                                        </div>
                                ...
                                <div x-show="subtab=='observation'" class="flex flex-col items-center justify-center">
                                    ...
                                    <div class="flex items-center justify-between w-2/3 pt-20 pb-16 mb-12">
                                        ...
                                        <div class="relative" x-data="{ observationText: false }">
                                            ...
                                            <textarea class="font-normal observation_description absolute px-2 py-2 bg-white rounded-xl w-[300px] right-0" x-show="observationText">{{ $edited_place && $edited_place->obsevation_description ? $edited_place->obsevation_description : '' }}</textarea>
                                        </div>
    ...
    <script>
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            var textarea = `
            <div class="flex flex-col w-full items-end mt-4 mb-6">
            ...
            markerx = L.marker([placelatitude, placelongitude], {
                ...
                `<div class="bg-[#2d9bf0] p-0 w-full">
                    ...
                    <div x-data="activeliked(${place.id},${like})" class="absolute bottom-[-5px] w-full left-0 px-[10px]">
                        <div class="flex italic font-light text-white justify-between items-center">
                            <div class="likecomment flex gap-10 items-center w-2/5">
                            ...
                            <div class="w-3/5">Added by ` + username + ` on ` + formattedDate + `</div>
                        </div>

                        <div class="absolute left-0 w-full" x-show="comment${place.id}">
                            <textarea type="text" data-id="${place.id}" class="feedback w-full rounded-xl h-[60px] focus:outline-none focus:border-0 focus:ring-0 bg-[#2d9bf0] border-0 italic text-white placeholder-white leading-2 text-sm w-10/12" placeholder="Put your feedback">`+comment+`</textarea>
        ...
        function activeliked(id,like){
            ...
            return { [`like${id}`]: like,[`comment${id}`]:false };
        }
        ...
        $('body').on('click', '.submitData', function() {
            ...
            if($homeTab=='place' && place_detail.id){
                ...
                setTimeout(() => {
                    if (edited_place && edited_place.observations_detail && edited_place.observations_detail.length > 0) {
                        edited_place.observations_detail.forEach(function(observation) {
                            if(observation.observation_child_id){
                                clickClass='feel_'+observation.observation_id+'_'+observation.observation_child_id+'_'+observation.feeling_id;
                            }else{
                                clickClass='feel_'+observation.observation_id+'_'+observation.feeling_id;
                            }
                            $('.'+clickClass).click();
                        });
                    }
