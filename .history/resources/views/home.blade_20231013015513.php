    ...
    <div data-barba="container">
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ subModelOpen: false, subtab:'place', subactive:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  x-cloak x-show="subModelOpen" class="fixed w-full bottom-0 z-[60] bg-white py-4">
                        <div class="flex items-center justify-center">
                            <div class="flex cursor-pointer items-center justify-center gap-2 px-8 py-3 text-lg font-extrabold text-white bg-[#2d9bf0] rounded-3xl hover:shadow  hover:bg-[#268ede] transition-all">
                                Close
                            </div>
                            
                            <div class="submitDataAll flex cursor-pointer items-center justify-center gap-2 px-8 py-3 text-lg font-extrabold text-white bg-[#2d9bf0] rounded-3xl hover:shadow  hover:bg-[#268ede] transition-all">
                                Submit
                            </div>
