            ...
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div x-data="{ showMore: false, height: 'auto' }">
                        <div x-cloak x-show="modelOpen " class="fixed bottom-0 z-50 overflow-y-auto"
                            ...
                            <div class="flex items-end justify-center text-center">
                                ...
                                <div x-cloak x-show="modelOpen" 
                                    ...
                                    class="transition-height parentDiv z-50 w-screen pb-16 transition-all transform bg-white h-[50%] shadow-xl mt-60 rounded-t-3xl"
                                    :style="'height: ' + height"
                        ...
                        x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                        x-transition:enter="transition ease-in duration-300"
                        x-cloak x-show="modelOpen" class="fixed w-full bottom-0 z-50 bg-white py-4">
                            <div class="flex items-center justify-center">
                                <div 
                                    {{-- onclick="submitData()" --}}
