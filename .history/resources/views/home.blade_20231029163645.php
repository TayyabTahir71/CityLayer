    ...
    <script>
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            markerx.on('popupopen', (event) => {
                ...
                if(temp_likes.includes(_id)){
                    $('body .likecomment .fa-heart').addClass('text-[#ffc543]');
                    $('body .likecomment .fa-heart').removeClass('fa-heart-o');
                    $('body .likecomment .fa-heart').addClass('liked');
                }
