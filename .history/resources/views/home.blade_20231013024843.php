    ...
    <div data-barba="container">
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div class="parentDiv" x-data="{ subModelOpen: true, subactive:''}" x-cloak x-show="subModelOpen">
                    <button class="hidden subModeltriger" @click="subModelOpen=true"></button>
                    <div  x-data="{ subtab: 'place' }"  class="fixed h-screen overflow-auto bottom-0 bg-white z-[60] w-full pb-8 text-xl font-semibold text-center shadow-xl">
                        ...
                        <div class="p-6 lg:p-12">
                            ...
                            <div>
                                ...
                                <div x-cloak x-show="subtab=='place'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
                                ...
                                <div x-cloak x-show="subtab=='observation'" class="flex flex-col items-center justify-center gap-10 mt-4 mb-6 italic font-semibold">
