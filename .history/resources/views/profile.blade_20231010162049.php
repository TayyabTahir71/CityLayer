    ...
    <div data-barba="container" class="p-6 lg:p-12">
        ...
        <div class="flex flex-col h-screen mx-auto">
            <div class="flex flex-col items-center pt-12 gap-x-6 lg:pt-20">
                ...
                <textarea clas type="text" value="" id="myTextArea" class="focus:outline-none focus:border-0 focus:ring-sky-500" placeholder="Place for a comment max 120 characters" />
