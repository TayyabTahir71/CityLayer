        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ modelOpen: false }">
                    ...
                    <div  x-data="{ showMore: false, height: 'auto' }" x-cloak x-show="modelOpen " class="fixed bottom-0 z-50 overflow-y-auto"
                        aria-labelledby="modal-title" role="dialog" aria-modal="true">
                        <div class="flex items-end justify-center text-center">
                            <div x-cloak @click="modelOpen = false" x-show="modelOpen"
                                
                                class=" inset-0 transition-opacity bg-gray-500 bg-opacity-40" aria-hidden="true">
                            </div>
                            ...
                            <div x-cloak x-show="modelOpen" 
                                ...
                                class="transition-height parentDiv z-50 w-screen p-4 transition-all transform bg-white h-[50%] shadow-xl mt-60 rounded-t-3xl"
                                :style="'height: ' + height"
                                ...
                                <div class="px-1 pt-4" x-data="{ tab: 'place' }">
                                    ...
                                    <input type="text" class="w-full px-2 py-2 bg-white rounded-full"
                                        ...
                                        <div style="font-size: 100px">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga illo, consequuntur praesentium deserunt velit molestias iste reprehenderit dolorum laborum quia odio nulla sequi magni, dicta voluptate labore maxime, distinctio sed.
                                        </div>
