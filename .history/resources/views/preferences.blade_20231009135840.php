                        ...
                        <div class="flex flex-row items-center justify-center gap-3 flex-wrap	">
                            ...
                            foreach ($preferences_array as $ref) {
                                ...
                                <label>
                                    ...
                                    <div class="bg-yel  border-ms px-5 italic font-light group  border ring-offset-2 peer-checked:text-white peer-checked:bg-[#CDB8EB] bg-purple-200 peer-focus:ring-2">
