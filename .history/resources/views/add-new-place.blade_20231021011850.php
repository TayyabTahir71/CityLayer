    ...
    <div  class="p-6 lg:p-12">
        ...
        <div class="parentDiv relative pt-20" x-cloak x-data="{tab: '{{$type}}',showMore: false}"
            ...
            >
                ...
                <button class="hidden OpenSubPlaceModel" @click="tab='observation';placeModel='child'"></button>
                ...
                <div class="mt-12 mb-12 text-center" x-show="placeModel=='child'">
                    <div class="placeparent mt-2 mb-10"></div>
                    <div  class="grid grid-cols italic font-semibold text-xl gap-10 subPlaceItems">
...
<script>
        ...
        $('body').on('click', '.submitDataAll', function() {
            ...
            if (parentDiv.hasClass('observationTab')) {
                ...
                if(parentDiv.find('.'+tab+'SubTab').hasClass('add')){
                ...
                }else if(parentDiv.find('.'+tab+'SubTab').hasClass('choose') && parentDiv.find('.ObservationItems').hasClass('parent')){
                    // choose observation
                    ...
                    return false;
                }else if(parentDiv.find('.'+tab+'SubTab').hasClass('choose') && parentDiv.find('.ObservationItems').hasClass('child')){
