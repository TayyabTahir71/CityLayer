                                ...
                                <div  x-show="subtab=='place'" class="flex items-start justify-center gap-10 mt-6 mb-6 italic font-semibold all-subplaces">
                                    <div class="grid grid-cols-3 italic font-semibold gap-10">
                                        ...
                                        <div class="flex flex-col items-center" @click="active='PL_2'">
                                            <div data-childplaces="[]" data-placeid="2" class="w-[76px] h-[76px] rounded-full bg-[#2d9bf0]" :class="active == 'PL_2' ? 'border-4 border-blue-300 placeActive' : ''">
                                                <div class="flex align-item-center justify-center items-center h-full">
                                                <img src="http://127.0.0.1:8000/new_img/image.png" class="w-7 h-7">
                                                </div>
                                            </div>
