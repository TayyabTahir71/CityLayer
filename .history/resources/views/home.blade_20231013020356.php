...
@section('main')
        ...
        <div class="flex flex-col mx-auto">
            <div class="">
                ...
                <div x-data="{ subModelOpen: true, subtab:'place', subactive:''}" x-cloak x-show="subModelOpen">
                    ...
                    <div  class="fixed h-screen bottom-0 bg-white z-[60] w-full pt-3 pb-8 text-xl font-semibold text-center shadow-xl parentDiv">
    ...
    <script>
        ...
        $('body').on('click', '.submitDataAll', function() {
            var place_detail = $(this).closest('.parentDiv').find('.subplaceActive').data('subplaceid');
