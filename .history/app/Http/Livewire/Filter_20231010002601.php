...
class Filter extends Component
{
    ...
    public function updateMap()
    {
        ...
        session(['placeIds' => $placeArray, 'observationIds' => $observationArray]);


        // $placeDetails = PlaceDetails::whereIn('place_id', $placeArray)
        //     ->orWhereIn('observation_id', $observationArray)
        //     ->get();
