...
class Filter extends Component
{
    ...
    foreach ($combined as $record) {
        if ($record->source === 'place') {
            // It's a record from the Place model
            echo "This is a Place: " . $record->name . "<br>";
        } elseif ($record->source === 'observation') {
            // It's a record from the Observation model
            echo "This is an Observation: " . $record->name . "<br>";
        }
    }
