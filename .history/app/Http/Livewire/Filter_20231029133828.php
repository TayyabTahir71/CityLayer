...
class Filter extends Component
{
    ...
    public function render()
    {
        ...
        $places = PlaceDetailPlace::all()->map(function ($placeDetail) {
            return (object) [
        ...
        $observations = ObservationDetail::all()->map(function ($observationDetail) {
            return (object) [
                'id' => $observationDetail->observation->id,
                'name' => $observationDetail->observation->name,
                'source' => 'observation',
            ];
        })->unique('id');
