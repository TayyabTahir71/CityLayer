...
class Filter extends Component
{
    ...
    public function render()
    {
        ...
        $places = PlaceDetails::join(DB::raw("(SELECT DISTINCT place_id FROM place_details WHERE user_id = $userid AND place_id IS NOT NULL) AS subquery"), function ($join) {
            $join->on('place_details.place_id', '=', 'subquery.place_id');
        })
