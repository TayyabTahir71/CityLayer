...
class GlobalController extends Controller
{
    ...
    public function community_achievements()
    {
        ...
        ])->orderBy('score', 'desc')->paginate(1)->get();
    ...
    public function loadMore_community_achievements(Request $request)
    {
        ...
        $usersWithTotals = User::withCount([...])->orderBy('score', 'desc')->paginate(10, ['*'], 'page', $page);
        // $html = view('users.load_more', compact('usersWithTotals'))->render();
