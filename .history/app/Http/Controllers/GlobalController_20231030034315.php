...
class GlobalController extends Controller
{
    ...
    public function allbadges(){
        ...
        $totalMappedPlaces = backpack_auth()->user()->placeDetails->count();
        $totalMappedObservations = backpack_auth()->user()->placeDetails->flatMap(function ($placeDetail) {
            return $placeDetail->observationsDetail->pluck('observation_id');
        })->unique()->count();
    
        $higherCount = max($totalMappedPlaces, $totalMappedObservations);
