...
class GlobalController extends Controller
{
    ...
    {
        $userid = backpack_auth()->user()->id;
        $placeDetails = User::with('placeDetails')->find($userid)->orderBy('id', 'desc')->placeDetails()->paginate(1);
        $score = backpack_auth()->user()->score;
    ...
    public function loadMore_dashboard(Request $request)
    {
        ...
        $placeDetails = User::with('placeDetails')->find($userid)->placeDetails()->paginate(10, ['*'], 'page', $page);

        $html = view('item_dashboard', compact('usersWithTotals'))->render();
