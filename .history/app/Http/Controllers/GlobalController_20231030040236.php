...
class GlobalController extends Controller
{
    ...
    public function allbadges(){
        ...
        $investigator = 0;
        $observationImagesCount = backpack_auth()->user()->placeDetails->sum(function ($placeDetail) {
            return !empty($placeDetail->obsevation_image) ? 1 : 0;
        });
        $placeImagesCount = backpack_auth()->user()->placeDetails->sum(function ($placeDetail) {
            return !empty($placeDetail->place_image) ? 1 : 0;
        });

        if(($placeImagesCount+$observationImagesCount)>=10){
            $investigator = 1;
        }
        ...
        return compact('explorer', 'citymaker', 'architect','flaneur',
        'urbanist',
        'influencer',
        'star',
        'guru',
