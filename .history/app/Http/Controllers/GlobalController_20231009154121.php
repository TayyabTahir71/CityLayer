...
class GlobalController extends Controller
{
    ...
    public function community_achievements()
    {
        ...
        foreach ($usersWithTotals as $user) {
            echo "User: {$user->name}\n";
            echo "Total Places: {$user->total_places}\n";
            echo "Total Observations: {$user->total_observations}\n";
        }
        ...
        return view('community_acheivements', compact('users', 'street', 'building', 'openspace'));
    }
