...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('opinion') }}"><i class="nav-icon la la-comment"></i> Opinions</a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('space-tag') }}"><i class="nav-icon la la-th-list"></i> Usage</a></li>
