...
@section('main')
    <div data-barba="container" class="p-6 lg:p-12">
        ...
        <div class="flex flex-col h-screen mx-auto">
            ...
            <div class="w-3/5 lg:w-3/6 mx-auto relative left-[17.5px]">
                <div class="absolute border-[#1876d2] text-[#1876d2] text-lg rounded-full text-center slider-circle">
                    {{ backpack_auth()->user()->score }}</div>
                ...
                <div class="flex flex-col">
                    <div class="flex gap-x-1">
                        ...
                        <button id="btn1" class="z-40">
                            @if ($explorer == 1)
                                <div class="flax ">
                                    ...
                                    <div class="font-style text-sm capitalize">explorer</div>
                                </div>
                            @else
                        ...
                        <button id="btn2" class="z-30">
                            @if ($citymaker == 1)
                                <div class="flax margl">
                                    ...
                                    <div class="font-style text-sm capitalize">city maker</div>
                                </div>
                            @else
                        ...
                        <button id="btn3" class="z-20">
                            @if ($architect == 1)
                                <div class="flax margl">
                                    ...
                                    <div class="font-style text-sm capitalize">architect</div>
                                </div>
                            @else
                                <div class="flax grayscale margl">
                                    <img src="{{ asset('images/color/CL_B-architect.svg') }}" alt="Your Image">
                        ...
                        <a href="/badges_overview" id="btn4" class="flax margl z-10">
                            ...
                            <div class="font-style text-sm capitalize text-center">see all</div>
                        </a>
            ...
            <div class="flex flex-row justify-center items-center gap-4">
                <a href="/"
                    class="px-6 py-4 font-bold border-2	font-sm rounded-3xl text-white bg-site border-site">Close</a>
                <a href="/edit_profile"
                    class="px-6 py-4 font-bold	font-sm rounded-3xl color-site border-2 border-site cursor-pointer">Edit
                    profile</a>
            </div>
    ...
    <script>
        ...
        button1.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/colors/CL_B-explorer.svg'><br><p>Explorer - Map a space that was not mapped before!</p>";
        ...
        button2.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/colors/CL_B-citymaker.svg'><br><p>City-maker – Map at least 10 spaces!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button3.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/architect.png'><br><p>Architect - Map at least 10 buildings!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button4.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/flaneur.png'><br><p>Flaneur - Map at least 10 streets!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button5.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/urbanist.png'><br><p>Urbanist - Map at least 10 open spaces!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button6.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/influencer.png'><br><p>Influencer – Receive 10+ comments by other users on one contribution!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button7.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/star.png'><br><p>Star - Receive 20+ reactions by other users on one contribution!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button8.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/guru.png'><br><p>Guru - Comment on 10 other people's posts!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button9.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/investigator.png'><br><p>Investigator - Post more that 10 pictures!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
        ...
        button10.addEventListener("click", function() {
            var popupContent =
                "<img class='mx-auto' src='/img/icons/supermapper.png'><br><p>Supermapper - Collect 500 points!</p>";
            popup.querySelector(".popup-content").innerHTML = popupContent;
            popup.style.display = "block";
        });
