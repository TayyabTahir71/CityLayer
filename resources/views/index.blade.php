        ...
        <div class="flex flex-col items-center h-screen p-8 mx-auto">
            <label for="dropzone-file"
                ...
                <div class="flex flex-col items-center justify-center pt-16 pb-6">
                    <h1 class="text-3xl font-bold text-center text-gray-900">{{ __('messages.welcome to') }}<br> CITY LAYERS!</h1>
            ...
            <section class="flex flex-col justify-center">
                <div class="flex justify-center">
                    <a href="login" class="py-4">
                        <button class="px-4 py-2 font-bold text-white bg-gray-700 rounded hover:bg-gray-800">{{ __('messages.Sign in') }}</button>
                    </a>
                </div>
                <div class="flex justify-center">
                    <a href="register">
                        <button class="px-4 py-2 font-bold text-white bg-gray-700 rounded hover:bg-gray-800">{{ __('messages. My first time here') }}</button>
                    </a>
                </div>
            </section>
