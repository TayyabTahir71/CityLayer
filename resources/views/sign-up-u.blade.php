                    ...
                    <div class="swiper-container swiper-images lg:w-[1400px] md:w-[900px] px-12  w-[300px]">
                        <div class="w-full swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <img class="object-cover saturate-120 md:w-[600px] [150px]  h-[330px] rounded" src="https://th.bing.com/th/id/R.869c978552ff253563b883e6f808f066?rik=%2b%2biVFdvlc%2fkfYA&riu=http%3a%2f%2fwww.hdwallpaper.nu%2fwp-content%2fuploads%2f2015%2f07%2f869c978552ff253563b883e6f808f066.jpg&ehk=rx%2f8Q%2fTPfE4eCNXaCEJ6y545Lj0ny4UsXQJOqgvvEv8%3d&risl=&pid=ImgRaw&r=0" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img class="object-cover saturate-120 md:w-[600px] [150px] h-[330px] rounded" src="https://th.bing.com/th/id/OIP.lXZVTGEcspIyDeXYxUiojQHaE7?pid=ImgDet&rs=1" alt="">
                            </div>
        ...
        <section class="">
            ...
            <form role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                ...
                <div class="flex flex-col items-center justify-center gap-4 mt-12">
                    <input type="text" placeholder="Username" name="name" id="name" class="form-input" required />


                    <input type="password" placeholder="Password" name="password" id="password" class="form-input" required />
                    <button type="submit" class="cursor-pointer btn btn-primary mb-3">
